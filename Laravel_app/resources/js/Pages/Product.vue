...
const sections = ref([
    { id: 1, color: '#89fe71', height: 'h-auto' },   // Sección 1: verde claro
    { id: 2, color: '#df70d7', height: 'h-auto' },   // Sección 2: rosa/magenta
    { id: 3, color: '#89fe71', height: 'h-auto' },   // Sección 3: verde claro
    { id: 4, color: '#34abeb', height: 'h-auto' },   // Sección 4: azul
    { id: 5, color: '#eb7134', height: 'h-auto' },   // Sección 5: naranja
    { id: 6, color: '#ff6b9d', height: 'h-auto' },   // Sección 6: rosa intenso
    { id: 7, color: '#ffd700', height: 'h-auto' },   // Sección 7: dorado
    { id: 8, color: '#7fff00', height: 'h-auto' },   // Sección 8: chartreuse
    { id: 9, color: '#ff4500', height: 'h-auto' },   // Sección 9: naranja rojizo
    { id: 10, color: '#00ced1', height: 'h-auto' },  // Sección 10: turquesa
    { id: 11, color: '#9370db', height: 'h-auto' },  // Sección 11: púrpura
    { id: 12, color: '#ff69b4', height: 'h-auto' },  // Sección 12: rosa caliente
    { id: 13, color: '#00ff7f', height: 'h-auto' }   // Sección 13: verde primavera
]);
        ...
        <div id="bg-dashboard" class="py-12 transition-colors duration-300">
            <div class="mx-auto w-full sm:px-6 lg:px-8">
                ...
                <div class="color-section m-5 shadow-sm sm:rounded-lg h-auto">
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 p-10 justify-items-center">
                        <ProductSmall 
                ...
                <div class="color-section m-5 shadow-sm sm:rounded-lg h-auto">
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 p-auto justify-items-center">
                        <ProductSmall 
                            imgSrc="/images/hydration_drinks/can-hydrate-lemon-label-product.png" 
                            alt="Lemon Lime Blast Can" 
                            text01="LEMON" 
                            text02="LIME BLAST" 
                        />
                        <ProductSmall 
                            imgSrc="/images/hydration_drinks/can-hydrate-cherry-label-product.png" 
                ...
                <div class="color-section m-5 shadow-sm sm:rounded-lg h-auto">
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 p-10">
                        <ProductBig
                            imgSrc="/images/whey_protein/whey-tub-vanilla.webp" 
                            alt="Vanilla Ice Cream Tub" 
                            text="VANILLA ICE CREAM"
                        />
                        <ProductBig
                            imgSrc="/images/whey_protein/whey-tub-chocolate.webp" 
                            alt="Chocolate Milkshake Tub" 
                            text="CHOCOLATE MILKSHAKE"
                        />
                        <ProductBig 
                            imgSrc="/images/whey_protein/whey-tub-caramel.webp" 
                ...
                <div class="color-section m-5 shadow-sm sm:rounded-lg h-auto">
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 p-10 justify-items-center">
                        ...
                        />
                        <ProductBig 
                            imgSrc="/images/hydro_beef/Tropical-Beef-1.webp" 
                            alt="Tropical Tub" 
                            text="TROPICAL" 
                        />
                    </div>
                ...
                <div class="color-section m-5 shadow-sm sm:rounded-lg h-auto">
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 p-10 justify-items-center">
                        ...
                        />
                        <ProductBig 
                            imgSrc="/images/BCAA/bcaa-tub-tropical-404x468-1.webp" 
                            alt="Tropical Tub" 
                            text="TROPICAL" 
                        />
                    </div>
                ...
                <div class="color-section m-5 shadow-sm sm:rounded-lg h-auto">
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 p-10 justify-items-center">
                        <ProductSmall
                            imgSrc="/images/L-Carnitine/shot-lemon-lcarnitine-product.png" 
                            alt="Lemon Carnitine" 
                            text01="LEMON" 
                            text02="3000 MG" 
                        />
                        <ProductSmall 
                            imgSrc="/images/L-Carnitine/shot-pineapple-lcarnitine-product.png" 
                ...
                <div class="color-section m-5 shadow-sm sm:rounded-lg h-auto">
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 p-10 justify-items-center">
                        <ProductBig 
                            imgSrc="/images/Pre-Workout/preeworkout-tub-blackcurrant-404x468-1.webp" 
                            alt="Blackcurrant Tub" 
                            text="BLACKCURRANT" 
                        />
                        <ProductBig 
                            imgSrc="/images/Pre-Workout/preeworkout-tub-blueberry-404x468-1.webp" 
                            alt="Apple Blueberry Tub" 
                            text="APPLE BLUEBERRY" 
                        />
                    </div>
                </div>
                ...
                <div class="color-section m-5 shadow-sm sm:rounded-lg h-auto">
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 p-10">
                        ...
                        <ProductBig 
                            imgSrc="/images/Protein_Bars/bar-protein-peanut-product.png" 
                            alt="Peanut Butter Bar" 
                            text="PEANUT BUTTER" 
                        />
                        <ProductBig 
                            imgSrc="/images/Protein_Bars/bar-protein-coco-product.png" 
                            alt="Chocolate Coconut Bar" 
                            text="CHOCOLATE COCONUT" 
                        />
                        <ProductBig 
                            imgSrc="/images/Protein_Bars/bar-protein-choc-product.png" 
                            alt="Chocolate Crunch Bar" 
                            text="CHOCOLATE CRUNCH" 
                        />
                    </div>
                </div>
